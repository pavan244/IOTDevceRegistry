...
@Component
public class SecurityProviderTPMEmulatorMyImpl extends SecurityProviderTpm
{
     ...
     */
    public SecurityProviderTPMEmulatorMyImpl() throws SecurityProviderException
    {
     ...
     * @throws SecurityProviderException If the constructor could not start the TPM
     */
    public SecurityProviderTPMEmulatorMyImpl(String registrationId) throws SecurityProviderException
    {
     ...
     * @throws SecurityProviderException If the constructor could not start the TPM
     */
    public SecurityProviderTPMEmulatorMyImpl(String registrationId, int tpmConnectRetryAttempts) throws SecurityProviderException
    {
        if (registrationId == null || registrationId.isEmpty())
        {
            throw new IllegalArgumentException("Registration Id cannot be null or empty");
     ...
     * @throws SecurityProviderException If the constructor could not start the TPM
     */
    public SecurityProviderTPMEmulatorMyImpl(String registrationId, String ipAddressSimulator) throws SecurityProviderException
    {
        if (registrationId == null || registrationId.isEmpty())
        {
            //SRS_SecurityProviderTPMEmulator_25_003: [ The constructor shall throw IllegalArgumentException if registration id was null or empty. ]
